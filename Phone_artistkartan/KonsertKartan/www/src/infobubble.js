...
//Denna är hämtad från Google, den är inte min men jag använder den, det är bättre att ha den på min server (läste jag..)
...
InfoBubble.prototype.buildDom_ = function() {
    ...
    google.maps.event.addDomListener(close, 'click', function() {
        ...
        if(that.contentWithoutButton !== undefined){
            that.content = that.contentWithoutButton;
        }
